...
/**
 * Essa classe extende Exception e é uma exceção criada para ser lançada ao tentar criar um triângulo com altura, base ou cor vazia
 * @author Eduardo Amorim dos Santos Araujo
 * @author Guilherme Trindade Souza
 */
public class TrianguloVazio extends Exception {
	 ...
	 * @param base recebe a base do triângulo
	 * @param cor recebe a cor do triângulo
	 */
	public TrianguloVazio(Color cor, String altura,String base) {
		super();
		valtura=altura;
		vbase=base;
		vc=cor;
	...
	public String getMessage() {
		...
		erro.append("Preencha os seguintes valores para criar seu Triângulo: ");
		if(valtura.equals("")) {
			erro.append(" |Altura| ");
		}
		if(vbase.equals("")) {
